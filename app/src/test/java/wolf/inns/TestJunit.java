...
public class TestJunit {
  ...
  public void testStaffCRUD() {
    ...
    assertEquals(
        "Update a staff", expected, InformationProcessing.retrieveStaff(actual_c.getStaffId()));
  ...
  public void testHotelsCRUD() {
    ...
    assertEquals(
        "Update a hotel", expected, InformationProcessing.retrieveHotel(actual_c.getHotelId()));
  ...
  public void testServiceStaffCRUD() {
    ...
    assertEquals(
        "Update a service staff",
        expected,
        InformationProcessing.retrieveServiceStaff(s.getStaffId()));

    // Delete a service staff
    assertTrue("Delete a service staff", InformationProcessing.deleteServiceStaff(expected));
    assertNull(
        "Delete a service staff", InformationProcessing.retrieveServiceStaff(s.getStaffId()));
  ...
  public void testServiceRecordsCRUD() { // CRU only
    ...
    expected.setServiceTime("10:10:10");
  ...
  // all my tests assume the existence of initial data entered as per Project
  // Report #2
  ...
  public void testRoomsCRUD() {
    ...
    expected.setAvailable("Y");

    /* Create */
    System.out.println("Testing createRoom...");
    Rooms actual = InformationProcessing.createRoom(1, "Test", 4, 2.0, "ECON", "Y");
  ...
  public void testRetrieveServiceStaffAssignmentsbyStaff() {
    ...
    // can't test default value case since all service staff have been assigned to
    // hotels in default
    // data
  ...
  public void testAssignDedicatedPresidentialSuiteStaff() {
    ...
    // create temp records for available service room service staff since there is
    // none in default
    // data
    ...
    assertTrue(
        ...
        HotelStayOperations.assignDedicatedPresidentialSuiteStaff(
            1,
            "Test",
            availCateringStaff.get(0).getStaffId(),
            availRoomServiceStaff.get(0).getStaffId(),
            connection));

    // clean up
    assertTrue(
        "Unassign dedicated staff from a Presidential Suite",
        HotelStayOperations.unassignDedicatedPresidentialSuiteStaff(1, "Test", connection));
  ...
  public void testOccupancyByCity() {
    ...
    // ideally I should be checking the values in the default data and verifying
    // that this query
     ...
     */
    System.out.println("No idea how to check this");
    System.out.println("Test for occupancyByCity passed");
  }
