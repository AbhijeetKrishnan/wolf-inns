...
public class Stays extends DatabaseObject {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof Stays)) {
      return false;
    }
    Stays s = (Stays) o;
    return (stayId == s.stayId
        && hotelId == s.hotelId
        && roomNumber.equals(s.roomNumber)
        && customerId == s.customerId
        && numOfGuests == s.numOfGuests
        && checkinDate.equals(s.checkinDate)
        && checkinTime.equals(s.checkinTime)
        && checkoutDate.equals(s.checkoutDate)
        && checkoutTime.equals(s.checkoutTime)
  ...
  public static Stays select() {
    ...
    ArrayList<DatabaseObject> databaseObjectList =
        (ArrayList<DatabaseObject>) ((ArrayList<?>) staffList);
