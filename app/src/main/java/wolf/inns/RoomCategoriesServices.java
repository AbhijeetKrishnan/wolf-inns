...
public class RoomCategoriesServices extends DatabaseObject {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RoomCategoriesServices)) {
      return false;
    }
    RoomCategoriesServices r = (RoomCategoriesServices) o;
    return (categoryCode.equals(r.categoryCode) && serviceCode.equals(r.serviceCode));
  }
  ...
  public static RoomCategoriesServices select() {
    ...
    ArrayList<RoomCategoriesServices> roomCategoriesServicesList =
        InformationProcessing.retrieveAllRoomCategoriesServices();
    ArrayList<DatabaseObject> databaseObjectList =
        (ArrayList<DatabaseObject>) ((ArrayList<?>) roomCategoriesServicesList);

    RoomCategoriesServices selectedRecord =
        (RoomCategoriesServices) MenuUtilities.paginatedRecordSelection(databaseObjectList);
