...
public class PaymentMethods extends DatabaseObject {
  ...
  public boolean equals(Object o) {
    ...
    return (payMethodCode.equals(p.payMethodCode) && payMethodDesc.equals(p.payMethodDesc));
  }
  ...
  public static PaymentMethods select() {
    ...
    ArrayList<PaymentMethods> paymentMethodsList =
        MaintainBillingRecords.retrieveAllPaymentMethods();
    ArrayList<DatabaseObject> databaseObjectList =
        (ArrayList<DatabaseObject>) ((ArrayList<?>) paymentMethodsList);

    PaymentMethods selectedRecord =
        (PaymentMethods) MenuUtilities.paginatedRecordSelection(databaseObjectList);
