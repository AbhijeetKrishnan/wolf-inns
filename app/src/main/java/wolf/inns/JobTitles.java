...
public class JobTitles extends DatabaseObject {
  ...
  public static JobTitles select() {
    ...
    JobTitles selectedRecord =
        (JobTitles) MenuUtilities.paginatedRecordSelection(databaseObjectList);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof JobTitles)) {
      return false;
    }
    JobTitles j = (JobTitles) o;
    return (titleCode.equals(j.titleCode) && titleDesc.equals(j.titleDesc));
  }
}
