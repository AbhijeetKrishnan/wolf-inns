...
public class RoomCategories extends DatabaseObject {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RoomCategories)) {
      return false;
    }
    RoomCategories r = (RoomCategories) o;
    return (categoryCode.equals(r.categoryCode) && categoryDesc.equals(r.categoryDesc));
  }
  ...
  public static RoomCategories select() {
    ...
    ArrayList<RoomCategories> roomCategoriesServicesList =
        InformationProcessing.retrieveAllRoomCategories();
    ArrayList<DatabaseObject> databaseObjectList =
        (ArrayList<DatabaseObject>) ((ArrayList<?>) roomCategoriesServicesList);

    RoomCategories selectedRecord =
